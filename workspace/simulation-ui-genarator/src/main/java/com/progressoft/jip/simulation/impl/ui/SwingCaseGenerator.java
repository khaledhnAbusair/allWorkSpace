...
public class SwingCaseGenerator extends JPanel implements CaseGenerator {
	...
	private SimulationFactory simulation;

	public SwingCaseGenerator(SimulationFactory simulation) {
	...
	private void addSimulationStart() {
		...
		startButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Simulation createSimulation = simulation.createSimulation();
				createSimulation.start(simCase);
				
				SimulationStateDisplay dialog = new SimulationStateDisplay(createSimulation);
				dialog.pack();
