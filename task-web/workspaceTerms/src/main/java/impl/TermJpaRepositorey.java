...
import exceptions.CannotAddTermWithRootName;
...
import exceptions.TermCategoryCannotBeenDeletedBecauseHasTermBelong;
...
public class TermJpaRepositorey implements TermRepository {
	...
	public void addTerm(Term term) {
		...
		try {
			...
			if (term.getTermName().equalsIgnoreCase(ROOT))
				throw new CannotAddTermWithRootName();
	...
	private void validateTermIfYouHavetheChild(Term term) {
		if (!term.getTerms().isEmpty()) {
			throw new TermCategoryCannotBeenDeletedBecauseHasTermBelong();
		}
	}
